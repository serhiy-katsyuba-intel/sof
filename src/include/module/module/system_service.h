...
/* Public interface versions are opaque values used by the versioned GetInterface(). */
enum interface_version {
	INTERFACE_VERSION_GNA_V1 = 0x1000,
	INTERFACE_VERSION_INFERENCE_SERVICE_V1 = 0x1000,
	INTERFACE_VERSION_INFERENCE_SERVICE_V2 = 0x1001,
	INTERFACE_VERSION_SDCA_V1 = 0x1000,
	INTERFACE_VERSION_ASYNC_MESSAGE_SERVICE_V1 = 0x1000,
	INTERFACE_VERSION_AM_SERVICE_V1 = 0x1000,
	INTERFACE_VERSION_KPB_SERVICE_V1 = 0x1000,
	INTERFACE_VERSION_KPB_SERVICE_V2 = 0x1001,
	INTERFACE_VERSION_TIMESTAMPING_SERVICE_V1 = 0x1000,
};

/* Versions exposed to modules built against the current IADK headers. */
#define INTERFACE_VERSION_GNA			INTERFACE_VERSION_GNA_V1
#define INTERFACE_VERSION_INFERENCE_SERVICE	INTERFACE_VERSION_INFERENCE_SERVICE_V2
#define INTERFACE_VERSION_SDCA			INTERFACE_VERSION_SDCA_V1
#define INTERFACE_VERSION_ASYNC_MESSAGE_SERVICE	INTERFACE_VERSION_ASYNC_MESSAGE_SERVICE_V1
#define INTERFACE_VERSION_AM_SERVICE		INTERFACE_VERSION_AM_SERVICE_V1
#define INTERFACE_VERSION_KPB_SERVICE		INTERFACE_VERSION_KPB_SERVICE_V2
#define INTERFACE_VERSION_TIMESTAMPING_SERVICE	INTERFACE_VERSION_TIMESTAMPING_SERVICE_V1
