...
#ifndef ZEPHYR_NEURAL_NET_INTEL_GNA34_GNA_MODEL_DB_H_
#define ZEPHYR_NEURAL_NET_INTEL_GNA34_GNA_MODEL_DB_H_

typedef struct _gna_model_db_t {
	gna_model_internal *buffer;
	uint32_t db_next_alloc_idx;
	uint32_t num_free_elem;
} gna_model_db_t;
BUILD_ASSERT(sizeof(gna_model_db_t) == SIZE_OF_GNA_MODEL_DB_T, "Wrong size of gna_model_db_t");
...
#endif /* ZEPHYR_NEURAL_NET_INTEL_GNA34_GNA_MODEL_DB_H_ */
